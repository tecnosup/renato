    ...
    <AnimatePresence>
      {toast && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-50 max-w-sm w-full bg-[#111214] text-[#e2e2e2] p-5 rounded-2xl border border-gold/15 shadow-2xl flex items-start gap-4 text-left"
