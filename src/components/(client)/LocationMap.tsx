...
export default function LocationMap() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gold/5 rounded-full blur-[140px] pointer-events-none hidden md:block" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <span className="font-sans text-[8px] text-[#c2a35d] tracking-[0.25em] uppercase flex items-center gap-2 font-bold mb-3">
          ...
          <h2 className="font-display font-light text-3xl md:text-5xl text-white uppercase tracking-wide">
            Visite o <span className="text-[#c2a35d] italic font-serif font-light">Nosso Templo</span>
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <motion.a
            ...
            className="lg:col-span-8 group relative block h-[300px] md:h-[440px] rounded-3xl overflow-hidden border border-white/10 hover:border-gold/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_10px_40px_rgba(0,0,0,0.5)] transition-all duration-500"
          >
            {/* iframe do mapa real */}
            <iframe
              src={EMBED_SRC}
            ...
            <div className="absolute bottom-4 right-4 z-20 flex items-center gap-2 bg-black/80 md:backdrop-blur-sm border border-gold/25 text-gold px-3.5 py-2 rounded-xl font-mono text-[9px] uppercase tracking-widest font-bold group-hover:border-gold/60 group-hover:bg-[#c2a35d] group-hover:text-zinc-950 transition-all duration-300 select-none">
          ...
          >
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-full bg-[#c2a35d]/10 border border-[#c2a35d]/25 flex items-center justify-center text-gold shrink-0">
                  <MapPin className="w-4 h-4" />
                </div>
                <div>
                  <span className="font-mono text-[8px] text-[#c2a35d]/70 uppercase tracking-widest font-bold block mb-1.5">Endereço</span>
              ...
              <div className="flex items-start gap-3 border-t border-white/5 pt-5">
                ...
                <div>
                  <span className="font-mono text-[8px] text-[#c2a35d]/70 uppercase tracking-widest font-bold block mb-1.5">Telefone</span>
                  <a href={`tel:+${ENDERECO.telefoneRaw}`} className="font-sans text-sm text-white font-semibold hover:text-gold transition-colors">
                    {ENDERECO.telefone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 border-t border-white/5 pt-5">
                ...
                <div>
                  <span className="font-mono text-[8px] text-[#c2a35d]/70 uppercase tracking-widest font-bold block mb-1.5">Funcionamento</span>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-7 relative overflow-hidden h-12 bg-linear-to-r from-[#ece4cb] to-[#c2a35d] text-slate-950 font-sans text-[10.5px] font-black tracking-[0.15em] uppercase rounded-xl flex items-center justify-center gap-2 hover:opacity-90 transition-all duration-300 shadow-[0_0_20px_rgba(194,163,93,0.25)] active:scale-[0.98] group/rota"
            >
