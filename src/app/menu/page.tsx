...
export default function MenuPage() {
  return (
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="transform-gpu mx-4 mb-3 rounded-2xl overflow-hidden bg-white/2 backdrop-blur-md backdrop-saturate-150 border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.15),0_4px_20px_rgba(0,0,0,0.25)] p-1">
        <Link href="/alertas" className="flex items-center gap-4 hover:bg-white/8 rounded-xl px-3 py-3.5 transition-colors">
        ...
        <Link href="/notificacoes" className="flex items-center gap-4 hover:bg-white/8 rounded-xl px-3 py-3.5 transition-colors">
